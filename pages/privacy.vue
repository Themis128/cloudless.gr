      ...
      <div class="policy-content">
        ...
        <section class="policy-section">
          ...
          <ul>
            ...
            <li>Enable bot creation, model training, and pipeline execution</li>
          ...
          <ul>
            ...
            <li>Send security alerts and account-related communications</li>
          </ul>
        ...
        <section class="policy-section">
          ...
          <ul>
            ...
            <li>Respond to government requests and legal proceedings</li>
          </ul>
        ...
        <section class="policy-section">
          ...
          <ul>
            ...
            <li>Update and correct your account information</li>
          ...
          <p>You can request a copy of your data, including:</p>
          <ul>
            ...
            <li>Project data and collaboration information</li>
          </ul>
        ...
        <section class="policy-section">
          ...
          <ul>
            ...
            <li>Maintain form data during multi-step processes</li>
          </ul>

          <h3>7.3 Analytics</h3>
          <p>We use analytics tools to:</p>
          <ul>
            <li>Understand how users interact with our platform</li>
            <li>Identify areas for improvement</li>
            <li>Measure feature adoption and usage</li>
        ...
        <section class="policy-section">
          ...
          <h3>8.2 External APIs</h3>
          <p>We may integrate with third-party APIs for:</p>
          <ul>
