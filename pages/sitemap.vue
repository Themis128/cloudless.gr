    ...
    <div class="sitemap-content">
        ...
        <ul class="sitemap-links">
          <li>
            ...
            <p class="link-description">
              Welcome to Cloudless - Cloud solutions and web development services
            </p>
          </li>
          <li>
            <NuxtLink to="/projects" class="sitemap-link">Projects</NuxtLink>
            <p class="link-description">
              Explore our portfolio of client projects and case studies
            </p>
          </li>
          <li>
      ...
      <div class="sitemap-section">
        ...
        <ul class="sitemap-links">
          ...
          <li v-for="(project, index) in featuredProjects" :key="index">
            <NuxtLink :to="`/projects/${project.slug}`" class="sitemap-link">{{
              project.title
            }}</NuxtLink>
      ...
      <div v-if="isAdmin" class="sitemap-section admin-section">
        ...
        <ul class="sitemap-links">
          ...
          <li>
            <NuxtLink to="/admin/contact-submissions" class="sitemap-link"
              >Contact Submissions</NuxtLink
            >
