  ...
  <v-card class="ma-4">
        ...
        <v-row>
          ...
          >
            <v-card
              :class="[
                'deployment-card',
                `deployment-card--${deployment.status}`
              ]"
              variant="outlined"
            >
    ...
    <v-dialog v-model="detailsDialog" max-width="800">
      <v-card v-if="selectedDeployment">
        <v-card-title>
          {{ selectedDeployment.deployment_name }} Details
        </v-card-title>
        <v-card-text>
          <v-row>
            <v-col cols="12" md="6">
              ...
              <div class="text-body-2 mb-1">
                <strong>Auto Scaling:</strong> {{ selectedDeployment.auto_scaling ? 'Enabled' : 'Disabled' }}
              </div>
            </v-col>
            <v-col cols="12" md="6">
