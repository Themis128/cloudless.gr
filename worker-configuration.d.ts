/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 30a99d7cf7de7198975792c115401523)
// Runtime types generated with workerd@1.20260630.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	...
	SESSION_TOKEN_STORE_TABLE: string;
	USER_PROFILE_TABLE: string;
	STRIPE_TRANSACTIONS_TABLE: string;
	ADMIN_NOTIFICATIONS_TABLE: string;
	ANALYTICS_CACHE_TABLE: string;
	...
	TAILSCALE_NAMESPACE: string;
	TAILSCALE_ACCEPT_DNS: string;
	TAILSCALE_USERNAME: string;
	TAILSCALE_PASSWORD: string;
	PI_HOSTNAME: string;
	PI_NODE_NAME: string;
	...
	HelloWorkflow: Workflow<Parameters<import("./src/index").HelloWorkflow['run']>[0]['payload']>;
	AI?: Ai;
	CounterAgent?: DurableObjectNamespace<import("./src/index").CounterAgent>;
	EchoAgent?: DurableObjectNamespace<import("./src/index").EchoAgent>;
	CodingAgent?: DurableObjectNamespace<import("./src/index").CodingAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CounterAgent" | "EchoAgent" | "CodingAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_SECRET" | "AUTH_URL" | "AUTH_TRUST_HOST" | "COGNITO_ISSUER" | "COGNITO_USER_POOL_ID" | "COGNITO_DOMAIN" | "COGNITO_CLIENT_ID" | "COGNITO_CLIENT_SECRET" | "NEXT_PUBLIC_COGNITO_USER_POOL_ID" | "NEXT_PUBLIC_COGNITO_CLIENT_ID" | "NEXT_PUBLIC_AUTH_PROVIDER" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_APP_URL" | "APP_VERSION" | "AWS_REGION" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "SESSION_TOKEN_STORE_TABLE" | "USER_PROFILE_TABLE" | "STRIPE_TRANSACTIONS_TABLE" | "ADMIN_NOTIFICATIONS_TABLE" | "ANALYTICS_CACHE_TABLE" | "LOCAL_LLM_BASE_URL" | "LANGGRAPH_URL" | "LANGSMITH_API_KEY" | "LANGSMITH_TRACING" | "LANGSMITH_ENDPOINT" | "APPFLOWY_API_URL" | "APPFLOWY_JWT_SECRET" | "AWS_DEFAULT_REGION" | "TAVILY_API_KEY" | "TAILSCALE" | "CLOUDFLARE_API_TOKEN" | "TAILSCALE_API" | "TAILSCALE_API_KEY" | "TAILSCALE_CLIENT_ID" | "TAILSCALE_CLIENT_SECRET" | "TAILSCALE_HOSTNAME" | "TAILSCALE_NAMESPACE" | "TAILSCALE_ACCEPT_DNS" | "TAILSCALE_USERNAME" | "TAILSCALE_PASSWORD" | "PI_HOSTNAME" | "PI_NODE_NAME" | "GITHUB_PERSONAL_ACCESS_TOKEN" | "ANTHROPIC_API_KEY" | "ANTHROPIC_CHAT_MODEL" | "GEMINI_API_KEY" | "AGENT_AUTH_TOKEN">> {}
}
