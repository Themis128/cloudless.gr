<template>
  <v-app>    <!-- Vanta.js Clouds2 Background -->
    ...
    >
      ...
      <v-list density="compact" nav>
        ...
        <v-list-item prepend-icon="mdi-sitemap" title="Workflows" value="workflows" to="/workflows" />
    ...
    <v-bottom-navigation
      ...
      app
    >
      <v-btn to="/dashboard" icon><v-icon>mdi-view-dashboard</v-icon><v-tooltip activator="parent" location="top"><span>Dashboard</span></v-tooltip></v-btn>
      <v-btn to="/builder" icon><v-icon>mdi-cube-outline</v-icon><v-tooltip activator="parent" location="top"><span>Builder</span></v-tooltip></v-btn>
      <v-btn to="/agents" icon><v-icon>mdi-robot</v-icon><v-tooltip activator="parent" location="top"><span>Agents</span></v-tooltip></v-btn>
    </v-bottom-navigation>
  </v-app>
</template>
