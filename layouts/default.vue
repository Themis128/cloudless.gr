      ...
      <header class="app-header">
        <div class="header-content">
          ...
          <nav class="nav-menu">
            ...
            <div class="nav-group">
              <span class="nav-group-title">AI</span>
              <NuxtLink to="/llm" class="nav-link">
                <v-icon size="16">mdi-brain</v-icon>
                LLM
              </NuxtLink>
              <NuxtLink to="/llm/train" class="nav-link">
            ...
            <div class="nav-group">
              ...
              <NuxtLink to="/deploy" class="nav-link">
              ...
              <NuxtLink to="/debug" class="nav-link">
            ...
            <div class="nav-group">
              <span class="nav-group-title">Resources</span>
              <NuxtLink to="/documentation" class="nav-link">
        ...
        <div v-if="showMobileMenu" class="mobile-menu">
          <div class="mobile-nav-group">
            ...
            <NuxtLink to="/projects" class="mobile-nav-link" @click="showMobileMenu = false">
              <v-icon size="20">mdi-folder-multiple</v-icon>
              Projects
            </NuxtLink>
            <NuxtLink to="/bots" class="mobile-nav-link" @click="showMobileMenu = false">
              <v-icon size="20">mdi-robot</v-icon>
              Bots
            </NuxtLink>
            <NuxtLink to="/models" class="mobile-nav-link" @click="showMobileMenu = false">
              <v-icon size="20">mdi-brain</v-icon>
              Models
            </NuxtLink>
            <NuxtLink to="/pipelines" class="mobile-nav-link" @click="showMobileMenu = false">
          ...
          <div class="mobile-nav-group">
            ...
            <NuxtLink to="/llm" class="mobile-nav-link" @click="showMobileMenu = false">
              <v-icon size="20">mdi-brain</v-icon>
              LLM
            </NuxtLink>
            <NuxtLink to="/llm/train" class="mobile-nav-link" @click="showMobileMenu = false">
          ...
          <div class="mobile-nav-group">
            ...
            <NuxtLink to="/deploy" class="mobile-nav-link" @click="showMobileMenu = false">
              <v-icon size="20">mdi-rocket-launch</v-icon>
              Deploy
            </NuxtLink>
            <NuxtLink to="/dashboard" class="mobile-nav-link" @click="showMobileMenu = false">
              <v-icon size="20">mdi-view-dashboard</v-icon>
              Dashboard
            </NuxtLink>
            <NuxtLink to="/debug" class="mobile-nav-link" @click="showMobileMenu = false">
          ...
          <div class="mobile-nav-group">
            ...
            <NuxtLink to="/documentation" class="mobile-nav-link" @click="showMobileMenu = false">
              <v-icon size="20">mdi-book-open-variant</v-icon>
              Documentation
            </NuxtLink>
            <NuxtLink to="/support" class="mobile-nav-link" @click="showMobileMenu = false">
              <v-icon size="20">mdi-help-circle</v-icon>
              Support
            </NuxtLink>
            <NuxtLink to="/api-reference" class="mobile-nav-link" @click="showMobileMenu = false">
              <v-icon size="20">mdi-api</v-icon>
              API Reference
            </NuxtLink>
            <NuxtLink to="/tutorials" class="mobile-nav-link" @click="showMobileMenu = false">
              <v-icon size="20">mdi-school</v-icon>
              Tutorials
            </NuxtLink>
            <NuxtLink to="/community" class="mobile-nav-link" @click="showMobileMenu = false">
          ...
          <div class="footer-main">
            <div class="footer-brand-section">
              <div class="footer-logo">
                <div class="logo-container">
                  <svg width="32" height="32" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="48" height="48" rx="12" fill="url(#gradient)"></rect>
                    <circle cx="24" cy="24" r="14" fill="#fff"></circle>
                    <text x="50%" y="54%" text-anchor="middle" font-size="16" fill="#23232b" font-family="Arial, Helvetica, sans-serif" font-weight="600">CL</text>
                    <defs>
              ...
              <p class="footer-description">
                Empowering developers with intelligent, scalable cloud infrastructure and AI-driven automation tools.
              </p>
            ...
            <div class="footer-links-grid">
              <div class="footer-section">
                <h4 class="footer-section-title">
                  <v-icon size="16" class="section-icon">mdi-rocket-launch</v-icon>
                  Build
                </h4>
                <ul class="footer-links">
                  <li><NuxtLink to="/bots" class="footer-link">Bot Builder</NuxtLink></li>
                  <li><NuxtLink to="/models" class="footer-link">Model Training</NuxtLink></li>
                  <li><NuxtLink to="/pipelines" class="footer-link">Pipeline Creator</NuxtLink></li>
                  <li><NuxtLink to="/llm" class="footer-link">LLM Management</NuxtLink></li>
                </ul>
              </div>
              ...
              <div class="footer-section">
                ...
                <ul class="footer-links">
                  <li><NuxtLink to="/debug" class="footer-link">Debug Tools</NuxtLink></li>
                  <li><NuxtLink to="/deploy" class="footer-link">Deployment</NuxtLink></li>
              ...
              <div class="footer-section">
                <h4 class="footer-section-title">
                  <v-icon size="16" class="section-icon">mdi-book-open-variant</v-icon>
                  Resources
                </h4>
                <ul class="footer-links">
                  <li><NuxtLink to="/documentation" class="footer-link">Documentation</NuxtLink></li>
                  <li><NuxtLink to="/support" class="footer-link">Support</NuxtLink></li>
                  <li><NuxtLink to="/api-reference" class="footer-link">API Reference</NuxtLink></li>
                  <li><NuxtLink to="/tutorials" class="footer-link">Tutorials</NuxtLink></li>
                  <li><NuxtLink to="/community" class="footer-link">Community</NuxtLink></li>
                </ul>
              </div>
              
              <div class="footer-section">
                <h4 class="footer-section-title">
                  <v-icon size="16" class="section-icon">mdi-account-group</v-icon>
                  Company
                </h4>
                <ul class="footer-links">
        ...
        <div class="footer-bottom">
          <div class="footer-bottom-content">
            ...
            <div class="footer-bottom-links">
              ...
              <NuxtLink to="/terms" class="footer-bottom-link">Terms of Service</NuxtLink>
              <NuxtLink to="/cookies" class="footer-bottom-link">Cookie Policy</NuxtLink>
              <NuxtLink to="/support" class="footer-bottom-link">Support</NuxtLink>
            </div>
          </div>
        </div>
      </footer>
