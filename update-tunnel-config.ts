...
async function updateTunnelConfig() {
  try {
      ...
      config: {
        ingress: [
          ...
          },
          {
            ...
            service: "http://localhost:80",
            originRequest: { connectTimeout: "30s", httpHostHeader: "pi-origin.cloudless.gr" },
          },
          {
            hostname: "grafana.cloudless.gr",
            service: "http://192.168.1.128:30850",
            originRequest: { noTLSVerify: true, connectTimeout: "15s", tcpKeepAlive: "30s" },
          },
          {
            hostname: "postiz.cloudless.gr",
            service: "http://192.168.1.128:30500",
            originRequest: { connectTimeout: "15s", tcpKeepAlive: "30s" },
          },
          {
          ...
          },
          {
            ...
            originRequest: { connectTimeout: "30s", tcpKeepAlive: "60s" },
          },
          {
          ...
          },
          {
            ...
            originRequest: { connectTimeout: "10s", tcpKeepAlive: "30s" },
          },
          {
    ...
    console.log("Updated config:", JSON.stringify(result, null, 2));
  } catch (error) {
