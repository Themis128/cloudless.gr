 ...
 * - All copy is keyed by locale ("el" | "en").
 * - `tiers` is ordered cheapest → flagship; the last item is highlighted.
 */
...
export type Tier = {
  ...
  /** Where the Buy button goes. Replace with real Stripe links. */
  checkoutHref: string;
  featured?: boolean;
};
