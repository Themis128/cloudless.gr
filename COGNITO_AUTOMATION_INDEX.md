...
2. **Detailed Guide** → Read [`docs/COGNITO_SETUP.md`](./docs/COGNITO_SETUP.md) (15 min)
...
| [docs/COGNITO_SETUP.md](./docs/COGNITO_SETUP.md) | Detailed user guide | Need detailed instructions |
| [docs/COGNITO_AUTOMATION.md](./docs/COGNITO_AUTOMATION.md) | Architecture & design | Want to understand how it works |
...
| Problem | Link |
|---------|------|
| AWS credentials invalid | [COGNITO_SETUP.md#aws-credentials](./docs/COGNITO_SETUP.md#prerequisites) |
| AWS CLI not found | [COGNITO_SETUP.md#aws-cli-not-found](./docs/COGNITO_SETUP.md#aws-cli-not-found) |
| Permission denied | [COGNITO_SETUP.md#permission-denied](./docs/COGNITO_SETUP.md#permission-denied-or-unauthorizedoperation) |
| SSM parameter not found | [COGNITO_SETUP.md#parameter-not-found](./docs/COGNITO_SETUP.md#parameternot-found) |
| Dev server won't start | [COGNITO_SETUP.md#dev-server](./docs/COGNITO_SETUP.md#dev-server-wont-start-after-setup) |

## 📞 Getting Help

1. **Check the docs** → Start with [COGNITO_SETUP.md](./docs/COGNITO_SETUP.md)
...
- [Cognito Setup Guide](./docs/COGNITO_SETUP.md) — detailed user guide
- [Cognito Automation](./docs/COGNITO_AUTOMATION.md) — how the automation works end to end
