...
// ---------------------------------------------------------------------------
// Ollama local inference (OpenAI-compatible, self-hosted)
// ---------------------------------------------------------------------------
 ...
 * OLLAMA_BASE_URL   — e.g. http://100.121.191.7:11434 (Tailscale IP of WSL host)
 * OLLAMA_MODEL      — optional override; defaults to qwen2.5-coder:latest
 */
