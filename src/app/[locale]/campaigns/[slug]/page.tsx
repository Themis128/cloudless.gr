 ...
 *
 * EL/EN copy only. Pages render under any global locale prefix but fall back
 * to EN if we don't have copy in the visitor's locale.
 */
...
import { campaigns, getCampaign, isCampaignLocale, type Locale } from "@/data/campaigns";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const loc: Locale = isCampaignLocale(rawLocale) ? rawLocale : "en";
  return {
    ...
    <div className="cl-cam-page">
      ...
      <footer className="cl-cam-foot">
        <p>
          ...
          <a href={`/${rawLocale}/contact?topic=${c.slug}`}>
            {locale === "el"
