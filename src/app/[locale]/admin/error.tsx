      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-8 flex justify-center gap-3">
          <button
            type="button"
            onClick={reset}
            className="bg-neon-magenta/10 border-neon-magenta/50 text-neon-magenta hover:bg-neon-magenta/20 min-h-[44px] rounded-lg border px-6 py-3 font-mono text-sm font-semibold transition-all"
          >
            Try Again
          </button>
          <Link
