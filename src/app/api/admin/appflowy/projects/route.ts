/** * /api/admin/appflowy/projects — backed by AppFlowy (self-hosted Notion replacement). */ import {
  NextRequest,
  NextResponse,
} from "next/server";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const projects = views.filter((v) => v.type === "document").map(viewToProject);
