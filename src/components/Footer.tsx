  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        {/* Training / non-commercial notice — gated by NEXT_PUBLIC_PORTFOLIO_MODE.
            Operational launches (default) suppress this block so paid traffic
            doesn't bounce off "does not accept clients" copy. Re-enable for
            staging/showcase builds with NEXT_PUBLIC_PORTFOLIO_MODE=true. */}
