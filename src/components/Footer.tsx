        ...
        <div className="border-neon-cyan/10 mt-8 border-t pt-6">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2">
            {[
              ...
              { href: "/terms", key: "legal.termsTitle", fallback: "Terms of Service" },
              { href: "/cookies", key: "legal.cookiePolicyTitle", fallback: "Cookie Policy" },
              { href: "/refund", key: "legal.refundTitle", fallback: "Refund & Returns" },
            ].map((link) => (
              <Link
                key={link.href}
                href={link.href}
