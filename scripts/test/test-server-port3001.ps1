...
Write-Host "🔍 Testing Server on Port 3001..." -ForegroundColor Cyan
...
Write-Host "  Port: $env:NUXT_PORT" -ForegroundColor Yellow
...
Write-Host "🧪 Starting server on port 3001..." -ForegroundColor Blue
