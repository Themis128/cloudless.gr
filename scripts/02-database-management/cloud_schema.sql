...
BEGIN
  ...
  expires_at := public.now_greek() + INTERVAL '1 hour';
...
BEGIN
  ...
  SET 
    ...
    locked_until = CASE 
      ...
      THEN public.now_greek() + lockout_duration
      ELSE locked_until
    END,
    updated_at = public.now_greek()
  WHERE email = user_email;
...
BEGIN
  ...
  RETURN locked_until_time IS NOT NULL AND locked_until_time > public.now_greek();
END;
$$;
...
--
-- Name: COLUMN profiles.last_login; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN profiles.locked_until; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN profiles.reset_token_expires; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_deployments_model_version; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_profiles_email_verified; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_profiles_locked_until; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_training_sessions_project; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_userinfo_name; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: deployments deployments_model_version_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: model_versions model_versions_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: model_versions model_versions_training_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: training_sessions training_sessions_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: model_versions; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: projects projects_user_policy; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: userinfo; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION clear_reset_token(user_email text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION is_user_locked(user_email text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION reset_failed_login(user_email text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION to_greek_time(input_timestamp timestamp with time zone); Type: ACL; Schema: public; Owner: postgres
--
