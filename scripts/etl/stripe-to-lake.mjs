 ...
 * normalizes into the `transactions` schema, writes a single parquet
 * file to s3://BUCKET/lake/transactions/transactions.parquet.
 *
 * Runs daily via GitHub Actions. Overwrites the file each run (full refresh).
