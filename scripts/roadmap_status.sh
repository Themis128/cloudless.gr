...
echo "- R13 EspoCRM MariaDB hourly backup descoped to 24h RPO; covered by R10 daily EspoCRM backup"
...
echo "- R15 Cloudflare Access on admin tunnel hosts"
echo "- R17 Kuma monitors + ntfy/Slack channels"
echo "- R19 Monthly failover drill workflow"
echo
