...
export const NEWSLETTER_SLACK_APIS = [
...
export const PORTAL_APIS_DYNAMIC = [
  { template: "/api/portal/:token/deliverables", sample: "/api/portal/sample-token/deliverables" },
  { template: "/api/portal/:token/comments", sample: "/api/portal/sample-token/comments" },
] as const;
...
export const ADMIN_API_DYNAMIC = [
  ...
  { template: "/api/admin/calendar/[id]/publish", sample: "/api/admin/calendar/sample-id/publish" },
  ...
  { template: "/api/admin/analytics/workspaces/[id]", sample: "/api/admin/analytics/workspaces/sample-id" },
  { template: "/api/admin/postiz/posts/[id]", sample: "/api/admin/postiz/posts/sample-id" },
  { template: "/api/admin/postiz/posts/[id]/status", sample: "/api/admin/postiz/posts/sample-id/status" },
  { template: "/api/admin/postiz/posts/[id]/release-id", sample: "/api/admin/postiz/posts/sample-id/release-id" },
  { template: "/api/admin/postiz/posts/[id]/missing-content", sample: "/api/admin/postiz/posts/sample-id/missing-content" },
  { template: "/api/admin/postiz/posts/group/[id]", sample: "/api/admin/postiz/posts/group/sample-id" },
  { template: "/api/admin/postiz/integrations/[id]/trigger", sample: "/api/admin/postiz/integrations/sample-id/trigger" },
  { template: "/api/admin/postiz/integrations/[id]/connect", sample: "/api/admin/postiz/integrations/sample-id/connect" },
  { template: "/api/admin/postiz/integrations/[id]/settings", sample: "/api/admin/postiz/integrations/sample-id/settings" },
  { template: "/api/admin/postiz/analytics/post/[id]", sample: "/api/admin/postiz/analytics/post/sample-id" },
  { template: "/api/admin/postiz/analytics/integration/[id]", sample: "/api/admin/postiz/analytics/integration/sample-id" },
] as const;
