...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [
      ...
      "__tests__/notion-analytics.test.ts",
      "__tests__/notion-blog.test.ts",
      "__tests__/notion-calendar.test.ts",
      "__tests__/notion-case-studies.test.ts",
      "__tests__/notion-client.test.ts",
      "__tests__/notion-comments.test.ts",
      "__tests__/notion-docs.test.ts",
      "__tests__/notion-esp32.test.ts",
      "__tests__/notion-faqs.test.ts",
      "__tests__/notion-forms.test.ts",
      "__tests__/notion-gsc-reports.test.ts",
      "__tests__/notion-projects.test.ts",
      "__tests__/notion-reports.test.ts",
      "__tests__/notion-search.test.ts",
      "__tests__/notion-services.test.ts",
      "__tests__/notion-testimonials.test.ts",
